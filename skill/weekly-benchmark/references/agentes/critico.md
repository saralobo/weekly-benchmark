...
> Tenta refutar um achado do benchmark antes de ele entrar no relatório — checa fonte, data, causalidade e se não é artefato de falha de coleta. Use dentro do pipeline de benchmark semanal.
