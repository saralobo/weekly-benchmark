---
name: curador-visual
description: Busca referências de UI, design e arquitetura numa fonte visual, captura screenshot de cada uma e devolve JSON com crédito completo. Use dentro do pipeline de benchmark semanal quando a trilha visual estiver ligada.
