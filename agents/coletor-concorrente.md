---
name: coletor-concorrente
description: Coleta o estado atual de um concorrente nas dimensões pedidas e devolve JSON estruturado com fonte para cada fato. Use dentro do pipeline de benchmark semanal.
