---
name: analista
description: Interpreta um delta do benchmark à luz do produto e da decisão declarada no config, respondendo por que importa e o que fazer. Use dentro do pipeline de benchmark semanal.
