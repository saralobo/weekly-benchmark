---
name: publicador
description: Publica o relatório do benchmark em camadas — arquivo local, Artifact na URL estável e ping curto por e-mail. Use no fim do pipeline de benchmark semanal.
