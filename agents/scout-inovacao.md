---
name: scout-inovacao
description: Varre notícias, artigos, publicações e releases técnicos sobre o contexto declarado, por um ângulo de busca específico, e devolve JSON com fonte e data. Use dentro do pipeline de benchmark semanal quando a trilha de inovação estiver ligada.
